...
int main(int argc, char **argv)
{
  ...
  /* printf("(myid: %d) BEFORE EXCHANGE(nbrleft: %d; nbrright: %d; right_ghost_disp: %ld\n",myid, nbrleft,nbrright, right_ghost_disp); */
    ...
    if( putput ){
	exchangrma1(a, ny, s, e, wina, nbrleft, nbrright, right_ghost_disp);
    } else {
      exchangrma2(a, ny, s, e, wina, nbrleft, nbrright);
    }
    ...
    if( putput ){
      exchangrma1(b, ny, s, e, winb, nbrleft, nbrright, right_ghost_disp);
    } else {
      exchangrma2(b, ny, s, e, winb, nbrleft, nbrright);
    }
